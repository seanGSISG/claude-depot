...
- [Install Obsidian CLI](#install-obsidian-cli)
- [Get started](#get-started)
  - [Run a command](#run-a-command)
  - [Use the terminal interface](#use-the-terminal-interface)
- [Examples](#examples)
  - [Everyday use](#everyday-use)
  - [For developers](#for-developers)
- [How to](#how-to)
  - [Use parameters and flags](#use-parameters-and-flags)
  - [Target a vault](#target-a-vault)
  - [Target a file](#target-a-file)
...
- [Daily notes](#daily-notes)
  ...
  - [`daily:append`](#dailyappend)
  - [`daily:prepend`](#dailyprepend)
...
- [Plugins](#plugins)
  ...
  - [`plugins:restrict`](#pluginsrestrict)
  - [`plugin`](#plugin)
...
- [Properties](#properties)
  ...
  - [`property:remove`](#propertyremove)
...
- [Publish](#publish)
  ...
  - [`publish:remove`](#publishremove)
  - [`publish:open`](#publishopen)
...
- [Sync](#sync)
  ...
  - [`sync:read`](#syncread)
  - [`sync:restore`](#syncrestore)
  - [`sync:open`](#syncopen)
  - [`sync:deleted`](#syncdeleted)
- [Tags](#tags)
  - [`tags`](#tags)
  - [`tag`](#tag)
- [Tasks](#tasks)
...
- [Templates](#templates)
  - [`templates`](#templates)
  - [`template:read`](#templateread)
  - [`template:insert`](#templateinsert)
- [Themes and snippets](#themes-and-snippets)
  ...
  - [`snippets`](#snippets)
  - [`snippets:enabled`](#snippetsenabled)
  - [`snippet:enable`](#snippetenable)
  - [`snippet:disable`](#snippetdisable)
...
> Sources: https://help.obsidian.md/obsidian-cli/Obsidian+CLI
