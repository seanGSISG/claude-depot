...
*   **`noteContentFormat`**: The body of the note.
    ...
    *   Supports **template logic** (conditionals, loops, variable assignment) as documented in [clipper-logic.md](clipper-logic.md).
...
*   **`value`**: The value to populate. Can contain variables and the same **template logic** (conditionals, loops, variable assignment) as `noteContentFormat`; see [clipper-logic.md](clipper-logic.md).
